...
role :web, "inviteme.com"                          # Your HTTP server, Apache/etc
role :app, "inviteme.com"                         # This may be the same as your `Web` server
role :db,  "inviteme.com"   , :primary => true # This is where Rails migrations will run
